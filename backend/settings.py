...
CORS_ALLOWED_ORIGINS = [
    "http:/192.168.224.74",
    "https:/192.168.224.74",
    # "http://localhost:3000",  # Add production URL when deployed
    # "http://127.0.0.1:3000",  # Add production URL when deployed
]

CSRF_TRUSTED_ORIGINS = [
    "https://192.168.224.74",  # Add your frontend domain here
    "http://192.168.224.74",  # Add your frontend domain here
    # "http://127.0.0.1:3000",  # Add production URL when deployed
...
ALLOWED_HOSTS = ['localhost','192.168.224.74','192.168.48.121', '127.0.0.1:8000',]
# ALLOWED_HOSTS = ["*"]
